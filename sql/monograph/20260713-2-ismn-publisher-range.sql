-- ISMN publisher range v2.0.0-alpha.2
CREATE TABLE ismn_publisher_range (
  id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  publisher_identifier VARCHAR(15) NOT NULL,
  monograph_publisher_id INT UNSIGNED NOT NULL,
  ismn_range_id INT UNSIGNED NOT NULL,
  ...
  FOREIGN KEY (ismn_range_id) REFERENCES ismn_range(id)
