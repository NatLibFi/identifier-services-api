import {
  ...
  MONOGRAPH_EXPRESSION_AUTHOR_ROLES,
  MONOGRAPH_EXPRESSION_TYPES,
  MONOGRAPH_IDENTIFIERS,
  MONOGRAPH_MANIFESTATION_AUTHOR_ROLES,
...
export const monographExpressionAuthorRoleEnum = Object.values(MONOGRAPH_EXPRESSION_AUTHOR_ROLES);
export const monographManifestationAuthorRoleEnum = Object.values(MONOGRAPH_MANIFESTATION_AUTHOR_ROLES);
