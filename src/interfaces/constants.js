...
export const AUDIT_OPERATION_TYPES = {
  ISBN_PUBLISHER_INFORMATION_PACKAGE_DOWNLOAD: 'ISBN_PUBLISHER_INFORMATION_PACKAGE_DOWNLOAD',
  ISBN_PUBLISHER_EMAIL_LIST_DOWNLOAD: 'ISBN_PUBLISHER_EMAIL_LIST_DOWNLOAD'
};
