...
export const MONOGRAPH_MESSAGE_TYPES = {
  PUBLICATION_IDENTIFIER_ASSIGNED: 'PUBLICATION_IDENTIFIER_ASSIGNED',
  PUBLISHER_REGISTRY_JOINED: 'PUBLISHER_REGISTRY_JOINED',
  PUBLISHER_RANGE_DOWNLOAD: 'PUBLISHER_RANGE_DOWNLOAD',
};
