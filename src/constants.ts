...
export const SERIAL_PUBLICATION_REQUEST_STATUSES = {
...
export const SERIAL_PUBLICATION_MEDIUM = {
  PRINTED: 'PRINTED',
  ONLINE: 'ONLINE',
  CDROM: 'CDROM',
  OTHER: 'OTHER',
...
export const SERIAL_PUBLICATION_STATUS = {
...
export const SERIAL_MESSAGE_TYPES = {
  ISSN_ASSIGNMENT: 'ISSN_ASSIGNMENT',
  ISSN_LIST_DELIVERY: 'ISSN_LIST_DELIVERY',
};
